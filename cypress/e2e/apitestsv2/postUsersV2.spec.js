...
describe('Post user Request', () => {
    ...
    it.skip('Craete user Test using random email', () => { //This test case is having dynamic values which will pass always
    ...
    it('Craete user Test using random email', () => { //This test case is having dynamic values which will pass always
        ...
        cy.request({
            ...
            userId = res.body.id; //Store the ID of the created user
